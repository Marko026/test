    ...
    <FormField
      ...
      render={({ field }) => (
        <FormItem>
          ...
          <FormControl>
            <Input placeholder={placeholder} className="h-[46px] sm:h-[56px] bg-white-200 text-[14px] font-normal text-gray-400 dark:bg-gray-800 dark:text-white-200 focus:ring-transparent" {...field} />
          </FormControl>
          <FormMessage />
        </FormItem>
      )}
