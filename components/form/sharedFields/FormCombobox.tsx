        ...
        <FormItem>
          ...
          <Popover>
            <PopoverTrigger asChild>
              <FormControl>
                <Button variant="outline" role="combobox" className={cn("w-full sm:h-[56px] h-[46px] dark:bg-gray-800 bg-white-200 border-none text-gray-400 dark:text-gray-400  justify-between", !field.value && "text-muted-foreground")}>
                ...
                <CommandGroup>
                  {constant.map((car: any) => (
                    <CommandItem
                      ...
                      className="cursor-pointer dark:text-white-50 hover:!text-primary"
                    >
                      <Check className={cn("mr-2 h-4 w-4 text-primary ", car.value === field.value ? "opacity-100" : "opacity-0")} />
                      {car.label}
                    </CommandItem>
                  ))}
                </CommandGroup>
