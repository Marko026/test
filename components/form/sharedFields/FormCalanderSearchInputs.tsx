        ...
        <FormItem>
          ...
          <Popover>
            <PopoverTrigger asChild>
              <FormControl>
                <Button variant="ghost" className={cn("flex justify-between w-full bg-white-200 dark:bg-gray-800 dark:text-white-50 border-none h-[46px] rounded-md text-gray-400 font-normal text-xs leading-6 px-[11px] py-4 lg:h-[56px]")}>
                  {field.value ? (
