...
const Filter = ({ searchParams }: SearchParamProps) => {
  ...
  return (
    <div className="lg:pt-[41px] lg:px-6 lg:bg-white-50 dark:bg-gray-900 lg:dark:border-r-[1px] border-gray-850 ">
      <div className="hidden lg:block text-xs font-semibold text-blue-100 mb-7">SEARCH</div>

      <div className="flex gap-4 mb-8 lg:mb-[52px] ">
        <input type="text" placeholder="Search something here" className="w-full h-[46px] dark:border-gray-800 dark:bg-gray-850 text-gray-700 font-normal text-xs leading-6 px-[11px] py-4 bg-white-50 rounded-md border border-blue-50" />
        <div className="h-[48px] w-[48px] bg-white-50 rounded-[10px] flex items-center justify-center p-3 border border-blue-50 dark:bg-gray-900 dark:border-gray-800">
          <Image src="/icons/filter-dark.png" width={24} height={24} alt="filter" />
        </div>
      </div>

      <div className="hidden lg:block ">
        <div className="hidden lg:block text-xs  font-semibold text-blue-100 mb-7">TYPE</div>
        ...
        <div className="hidden lg:block text-xs  font-semibold text-blue-100 mb-7">CAPACITY</div>
        ...
        <div className="hidden lg:block text-xs  font-semibold text-blue-100 mb-7">PRICE</div>

        <div>
          <Slider className="w-[246px]" name="slider" defaultValue={[0]} max={200} onValueChange={(value: number[]) => onValueChange(value)} />
